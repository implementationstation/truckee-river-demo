        ...
        <v-row align="center">
          <v-col cols="12" md="8" lg="7">
            ...
            <p class="hero-subtitle mb-8">
              We have received all sorts of pre-trip questions so we figured this might help ease your mind.
            </p>
...
/* Changed */
  background:
    url('/images/l-unforgettable-family-river-rafting-tours-in-tahoe.webp');
