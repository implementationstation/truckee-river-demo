...
const items = [
  {
    title: "Local River Experts",
    description: "Guides who know every bend, rapid, and story of the Truckee.",
    icon: "mdi-map"
  },
  {
  ...
  },
  {
    ...
    description: "Gear, transport, and guidance handled. Just show up.",
