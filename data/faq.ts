...
*/
export const faqs = [
 //ATTEMPT #1 - CREATE A VIBEY FAQ LIST TO USE IN MY DEMO 
    // The goal here is to have an information bank that I can later modify to my requirements and preferences and whoever knows what else.
    //  https://raftirie.com/what-to-bring
    //  |GeneralInfo|CrucialRequirements|Troubleshooting-who do you call? Ghostbusters||Your Stuff|Pictures&Videos|Dry Clothing|WhatNotTOWear|
    //  |SummerWeatherRecommendations|
