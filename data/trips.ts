export const trips = [
  
  {
    ...
    priceYouth: '$100',
    whatsIncluded: [
      'We provide transportation to and from our office near Truckee (15-30 min).',
      'Cold drinks are provided at the end of your trip.',
      'PFDs, paddles, and helmets are provided for all guests.',
      'We will provide one large water jug per raft that clips into the boat.',
      'We ask that if you do bring your own water bottle that there is a way to fasten it to the raft.',
      'Wet suits are included in the trip cost if conditions warrant them.'
    ], 
    raftSizeCapacity: 'On the Truckee River We use 12in & 13in rafts that will fit up to 6 guests plus one guide.',
    meetTime: '09:00 & 13:30',
    tripTime: 'Approximately 3.5 hours round trip. Including transportation, gear up and safety orientation. (2 hours on the water)'
  }
]
